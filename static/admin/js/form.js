            ...
            case 'x-editable-boolean':
                $el.editable({
                    ...
                    display: function(value, response) {
                      ...
                      var glyph = (value == 'true') ? 'ok-circle' : 'minus-sign';
                      var fa = (value == 'true') ? 'fa-check' : 'fa-minus-circle';
                    ...
                    success: function(response, newValue) {
                      // update display
                      var glyph = (newValue == 'true') ? 'ok-circle' : 'minus-sign';
                      var fa = (newValue  == 'true') ? 'fa-check' : 'fa-minus-circle';
                      $(this).empty().append($('<span />', {
                        'class': `fa ${fa} glyphicon glyphicon-${glyph} icon-${glyph}`,
                        'title': $(this).parent().data('title'),
                      }));
